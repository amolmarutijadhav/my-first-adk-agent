"""
Web UI for Phase 2A: Modular ADK Architecture.
This provides a simple web interface to test the multi-agent system.
"""
...
app = FastAPI(
    ...
    description="Web UI for testing the modular ADK architecture",
    version="1.0.0"
)
...
async def get_ui():
    ...
    <body>
        <div class="header">
            ...
            <p>Modular ADK Architecture - Web Interface</p>
        </div>
...
async def process_query(request: QueryRequest):
    ...
    try:
        ...
        routing_decision = coordinator.routing_logic.analyze_query(request.query)
...
async def get_status():
    ...
    return {
        ...
        "system": "Phase 2A: Modular ADK Architecture"
    }
